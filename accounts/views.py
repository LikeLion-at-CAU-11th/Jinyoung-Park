...
def google_login(request):
    ...
    client_id = '950296069909-794l8mh36q038uigtn4djin549gsdpil.apps.googleusercontent.com'
...
def google_callback(request):
    # 실전에서는 secret.json 파일에 넣어놓고 꺼내서 사용해야 안전하다~
    client_id = "950296069909-794l8mh36q038uigtn4djin549gsdpil.apps.googleusercontent.com"
    client_secret = "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"
